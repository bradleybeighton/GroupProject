...
int main(int argc, char* argv[])
{
	...
	CvSize windowSize = cvSize(640, 480);			// use a 640 x 480 size for all windows, also make sure your webcam is set to 640x480 !!
	...
	p_imgProcessed = cvCreateImage(windowSize,			// 640 x 480 pixels (CvSize struct from earlier)
								   IPL_DEPTH_8U,		// 8-bit color depth
								   1);					// 1 channel (grayscale), if this was a color image, use 3

	p_imgHSV = cvCreateImage(windowSize, IPL_DEPTH_8U, 3); 
